const Hero = () => {
  return (
    <section className="h-[70vh] w-full flex items-center justify-center flex-col relative p-10 lg:p-0 z-10 ">
      ...
      <p className="text-2xl uppercase text-center my-2 font-thin tracking-widest gap-3 text-yellow-2">
      ...
      <p className="p-5 w-full lg:w-1/2 mx-auto text-center text-sm md:text-base lg:text-[20px]">
