...
const GalleryCarousel = () => {
  ...
  const [selectedImageIndex, setSelectedImageIndex] = useState<number | null>(
    null
  ); // track the index instead of the image
  ...
  return (
    <div
      className="carousel-container w-[80%] mx-auto relative select-none"
      ...
      <div className="carousel-wrapper" ref={emblaRef}>
        <div className="carousel flex">
          {images.map((image, index) => (
            <div
              className="carousel-slide relative px-2 w-full sm:w-1/2 lg:w-1/3"
              key={index}
              ...
              <div className="slide-content relative shadow-lg rounded-md overflow-hidden transition-all duration-600 ease-in-out">
                ...
                {hoveredIndex === index && (
                  <div
                    ...
                    <div className="absolute w-full h-full left-0 right-0 fade hover:bg-black-1/40 flex items-center justify-center">
                      <IconPlus
                        className=" text-4xl bg-red-1/50 text-white rounded-sm "
                        width={52}
                        height={52}
                      />
                    </div>
      ...
      {selectedImageIndex !== null && (
        <div className="fixed inset-0 bg-black bg-opacity-75 flex justify-center items-center z-50">
          <div className="bg-black-1/70 -z-10 w-full h-full absolute"></div>
